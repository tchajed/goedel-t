...
Lemma apply_substitution_renaming : forall Gamma t1 t2 (e: expr (t1 :: Gamma) t2)
    ...
    apply_renaming (renaming_shift t1 (var_shift t))
                   (apply_substitution (substitution_shift t1 s) e).
Proof.
  intros.
  rewrite apply_renaming_as_substitution.
  rewrite rename_substitution_shift_commute.
  auto.
Qed.
